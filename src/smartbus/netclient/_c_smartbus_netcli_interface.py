...
def load_lib(file_path=lib_filename):
    ...
    if not _lib:
        try:
            ...
            _c_fn_SetCallBackFn = _c_fntyp_SetCallBackFn(('SmartBusNetCli_SetCallBackFn', _lib),
                                                         _paramflags_SetCallBackFn)
            global _c_fn_CreateConnect
            _c_fn_CreateConnect = _c_fntyp_CreateConnect(('SmartBusNetCli_CreateConnect', _lib),
            ...
            _c_fn_RemoteInvokeFlow = _c_fntyp_RemoteInvokeFlow(('SmartBusNetCli_RemoteInvokeFlow', _lib),
            ...
            _c_fn_SetCallBackFnEx = _c_fntyp_SetCallBackFnEx(('SmartBusNetCli_SetCallBackFnEx', _lib),
