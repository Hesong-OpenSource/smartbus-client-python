...
_paramflags_SendData = (1, 'cmd', c_byte), (1, 'cmdtype', c_byte), (1, 'dst_unitid', c_int), (
    1, 'dst_clientid', c_int), (1, 'dst_clienttype', c_int), (1, 'data', c_void_p), (1, 'size', c_int)

_c_fntyp_RemoteInvokeFlow = CFUNCTYPE(c_int, c_int, c_int, c_char_p, c_char_p, c_int, c_int, c_char_p)
_paramflags_RemoteInvokeFlow = (1, 'server_unitid', c_int), (1, 'processindex', c_int), (1, 'projectid', c_char_p), (
    1, 'flowid', c_char_p), (1, 'mode', c_int), (1, 'timeout', c_int), (1, 'in_valuelist', c_char_p)

_c_fntyp_SendPing = CFUNCTYPE(c_int, c_int, c_int, c_int, c_void_p, c_int)
_paramflags_SendPing = (1, 'dst_unitid', c_int), (1, 'dst_clientid', c_int), (1, 'dst_clienttype', c_int), (
    1, 'data', c_void_p), (1, 'size', c_int)
...
_c_fntyp_SendNotify = CFUNCTYPE(c_int, c_int, c_int, c_char_p, c_char_p, c_int, c_int, c_char_p)
_paramflags_SendNotify = (1, 'server_unitid', c_int), (1, 'processindex', c_int), (1, 'projectid', c_char_p), (
...
def load_lib(filepath=lib_filename):
    ...
    if not _lib:
        try:
            ...
            _c_fn_SetCallBackFn = _c_fntyp_SetCallBackFn(('SmartBusIpcCli_SetCallBackFn', _lib),
                                                         _paramflags_SetCallBackFn)
            global _c_fn_CreateConnect
            _c_fn_CreateConnect = _c_fntyp_CreateConnect(('SmartBusIpcCli_CreateConnect', _lib),
                                                         _paramflags_CreateConnect)
            ...
            _c_fn_RemoteInvokeFlow = _c_fntyp_RemoteInvokeFlow(('SmartBusIpcCli_RemoteInvokeFlow', _lib),
                                                               _paramflags_RemoteInvokeFlow)
            ...
            _c_fn_SetCallBackFnEx = _c_fntyp_SetCallBackFnEx(('SmartBusIpcCli_SetCallBackFnEx', _lib),
                                                             _paramflags_SetCallBackFnEx)
            global _c_fn_SendNotify
            _c_fn_SendNotify = _c_fntyp_SendNotify(('SmartBusIpcCli_SendNotify', _lib), _paramflags_SendNotify)
