...
"""
ctypes for IPC client API.
"""

from __future__ import absolute_import

from ctypes import c_int, c_void_p, c_char_p, c_byte

from .helper import IpcFunc as ApiFunc, declare
from .mutual import *
...
class SetTraceStr(ApiFunc):
    argtypes = [fntyp_trace_str_cb, fntyp_trace_str_cb]
...
class CreateConnect(ApiFunc):
    argtypes = [c_char_p, c_char_p, c_char_p]
    restype = c_int


@declare(funcs)
class SendData(ApiFunc):
    argtypes = [c_byte, c_byte, c_int, c_int, c_int, c_void_p, c_int]
    restype = c_int


@declare(funcs)
class RemoteInvokeFlow(ApiFunc):
    argtypes = [c_int, c_int, c_char_p, c_char_p, c_int, c_int, c_char_p]
    restype = c_int


@declare(funcs)
class SendPing(ApiFunc):
    argtypes = [c_int, c_int, c_int, c_void_p, c_int]
    restype = c_int
