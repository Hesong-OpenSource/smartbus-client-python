...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        _cli = cls._cli = Client(localClientId=0, localClientType=25, masterHost='10.4.62.45', masterPort=8089, encoding='utf-8')
    ...
    def test_robot_connected(self):
        ...
        with self._recv_buf_lock:
            flowid = self._cli.invokeFlow(0, 0, 'Project2', '_webchat_rpc', {'method':'RobotConnected', 'params':['robot-001']}, True, 5)
            pending = [cond, None]
